...
router.get('/admin/add-history',  checkAdminAuthenticated, async (req, res) => {
    try {
...
router.get('/admin/search-user',  checkAdminAuthenticated, async (req, res) => {
    try {
        const { username } = req.query;
...
router.post('/admin/add-history', checkAdminAuthenticated, async (req, res) => {
    try {
...
router.get('/admin/history', checkAdminAuthenticated, async (req, res) => {
    try {
...
router.get('/admin/edit-history/:id', checkAdminAuthenticated, async (req, res) => {
    try {
...
router.post('/admin/edit-history/:id', checkAdminAuthenticated, async (req, res) => {
    try {
        const { id } = req.params;
...
router.post('/admin/delete-history/:id', checkAdminAuthenticated, async (req, res) => {
    try {
        const historyId = req.params.id;
